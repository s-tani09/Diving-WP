          ...
          <ul class="post-blog__items blog-cards blog-cards--2column">
            ...
            <li class="blog-cards__item blog-card">
              <a href="#">
                <div class="blog-card__container">
                  <div class="blog-card__image blog-card__image--large">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/blog-04.jpg"
                      alt="黄色い魚が泳いでいる様子" />
                  </div>
                  <div class="blog-card__body">
                    <div class="blog-card__meta">
            ...
            <li class="blog-cards__item blog-card">
              <a href="#">
                <div class="blog-card__container">
                  <div class="blog-card__image blog-card__image--large">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/blog-05.jpg"
                      alt="白と黒のシマシマの魚が海底を歩いている様子" />
                  </div>
                  <div class="blog-card__body">
                    <div class="blog-card__meta">
                      <time class="blog-card__date" datetime="2023-11-17">2023.11.17</time>
            ...
            <li class="blog-cards__item blog-card">
              <a href="#">
                <div class="blog-card__container">
                  <div class="blog-card__image blog-card__image--large">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/blog-06.jpg"
                      alt="海底にたくさんのクラゲが泳いでいる様子" />
                  </div>
                  <div class="blog-card__body">
                    <div class="blog-card__meta">
                      <time class="blog-card__date" datetime="2023-11-17">2023.11.17</time>
              ...
              <div class="voice-lists__item voice-list">
                <a href="#">
                  <div class="voice-list__image">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/voice-side.jpg"
                      alt="カップルが腕を組んで柔かに座っている様子" />
                  </div>
